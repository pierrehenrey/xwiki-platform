...
public interface Rating
{
     ...
     * @deprecated Since 12.6RC1 this method shouldn't be used anymore: Ratings are not necessarily stored as xobjects.
     */
    @Deprecated
     ...
     * @deprecated Since 12.6RC1: only {@link RatingsManager} should be responsible to save the ratings.
     */
    @Deprecated
     ...
     * @deprecated Since 12.6RC1: only {@link RatingsManager} should be responsible to remove the ratings.
     */
    @Deprecated
